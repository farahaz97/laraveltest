                ...
                <div class="mt-8 bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg">
                    <div class="grid grid-cols-1 md:grid-cols-2">
                        ...
                        <div class="p-6 border-t border-gray-200 dark:border-gray-700">
                            ...
                            <div class="ml-12">
                                <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                    first coding - Laravel News is a community driven portal and newsletter aggregating all of the latest and most important news in the Laravel ecosystem, including new package releases and tutorials.
                                </div>
                            </div>
                        </div>
...
<?php /**PATH C:\laragon\www\Cashier-POS\resources\views/welcome.blade.php ENDPATH**/ ?>